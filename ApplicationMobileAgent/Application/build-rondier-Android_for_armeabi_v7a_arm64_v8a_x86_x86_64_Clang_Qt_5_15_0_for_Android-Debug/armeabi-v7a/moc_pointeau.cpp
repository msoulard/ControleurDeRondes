...
QT_MOC_LITERAL(1, 9, 18), // "emplacementChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "couleurChanged"
QT_MOC_LITERAL(4, 44, 13), // "m_emplacement"
QT_MOC_LITERAL(5, 58, 9) // "m_couleur"

    },
    "Pointeau\0emplacementChanged\0\0"
    "couleurChanged\0m_emplacement\0m_couleur"
};
...
void Pointeau::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->emplacementChanged(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pointeau::emplacementChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getEmplacement(); break;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setEmplacement(*reinterpret_cast< QString*>(_v)); break;
...
// SIGNAL 0
void Pointeau::emplacementChanged()
{
