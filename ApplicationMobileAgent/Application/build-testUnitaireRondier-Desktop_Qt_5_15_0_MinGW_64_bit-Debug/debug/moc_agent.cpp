...
#include <memory>
#include "../../testUnitaireRondier/agent.h"
...
QT_MOC_LITERAL(1, 6, 15), // "obtenirNomAgent"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9) // "_numBadge"

    },
    "Agent\0obtenirNomAgent\0\0_numBadge"
};
...
void Agent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QString _r = _t->obtenirNomAgent((*reinterpret_cast< QString(*)>(_a[1])));
