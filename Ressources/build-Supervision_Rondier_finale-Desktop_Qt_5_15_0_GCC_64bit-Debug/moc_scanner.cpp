...
#include <memory>
#include "../Supervision_Rondier_finale3/scanner.h"
...
QT_MOC_LITERAL(1, 8, 10), // "nouveauTag"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 3), // "tag"
QT_MOC_LITERAL(4, 24, 18), // "onReadyReadScanner"
QT_MOC_LITERAL(5, 43, 25) // "onReadyReadListeSmarphone"

    },
    "Scanner\0nouveauTag\0\0tag\0onReadyReadScanner\0"
    "onReadyReadListeSmarphone"
};
...
void Scanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->nouveauTag((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->onReadyReadScanner(); break;
        case 2: _t->onReadyReadListeSmarphone(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scanner::nouveauTag)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Scanner::nouveauTag(QString _t1)
{
