...
#include <memory>
#include "../Supervision_Rondier_finale3/parametre.h"
...
QT_MOC_LITERAL(1, 10, 23), // "smartphoneScannerChange"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 28), // "on_pushButtonAnnuler_clicked"
QT_MOC_LITERAL(4, 64, 32), // "on_pushButtonEnregistrer_clicked"
QT_MOC_LITERAL(5, 97, 23), // "onListeSmartphoneChange"
QT_MOC_LITERAL(6, 121, 17), // "QList<Smartphone>"
QT_MOC_LITERAL(7, 139, 16) // "_listeSmartphone"

    },
    "Parametre\0smartphoneScannerChange\0\0"
...
void Parametre::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->smartphoneScannerChange((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_pushButtonAnnuler_clicked(); break;
        case 2: _t->on_pushButtonEnregistrer_clicked(); break;
        case 3: _t->onListeSmartphoneChange((*reinterpret_cast< QList<Smartphone>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Parametre::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parametre::smartphoneScannerChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Parametre::smartphoneScannerChange(QString _t1)
{
