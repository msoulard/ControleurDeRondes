...
#include <memory>
#include "../Supervision_Rondier_finale3/qdevicewatcher.h"
...
void QDeviceWatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QDeviceWatcher *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QDeviceWatcher::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDeviceWatcher::deviceAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QDeviceWatcher::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDeviceWatcher::deviceChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QDeviceWatcher::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDeviceWatcher::deviceRemoved)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QDeviceWatcher::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QDeviceWatcher.data,
    qt_meta_data_QDeviceWatcher,
    qt_static_metacall,
    nullptr,
    nullptr
} };
