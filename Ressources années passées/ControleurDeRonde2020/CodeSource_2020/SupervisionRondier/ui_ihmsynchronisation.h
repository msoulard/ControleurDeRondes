...
public:
    ...
    //Modifications 2020
    QVBoxLayout *verticalLayoutDetecterSmartphone;
    QLabel *labelDetecterSmartphone;
    QPushButton *pushButtonDetecter;
    ...
    void setupUi(QWidget *IHMSynchronisation)
    {
        if (IHMSynchronisation->objectName().isEmpty())
               ...
               //Modifications 2020
               verticalLayoutDetecterSmartphone = new QVBoxLayout();
               verticalLayoutDetecterSmartphone->setSpacing(6);
               verticalLayoutDetecterSmartphone->setObjectName(QStringLiteral("verticalLayoutDetecterSmartphone"));
               labelDetecterSmartphone = new QLabel(IHMSynchronisation);
               labelDetecterSmartphone->setObjectName(QStringLiteral("labelDetecterSmartphone"));

               verticalLayoutDetecterSmartphone->addWidget(labelDetecterSmartphone);

               pushButtonDetecter = new QPushButton(IHMSynchronisation);
               pushButtonDetecter->setObjectName(QStringLiteral("pushButtonDetecter"));
               pushButtonDetecter->setEnabled(true);
               pushButtonDetecter->setMinimumSize(QSize(150, 40));
               QIcon iconDetection;
               iconDetection.addFile(QStringLiteral(":/images/smartphoneAddIcon.png"), QSize(), QIcon::Normal, QIcon::On);
               pushButtonDetecter->setIcon(iconDetection);
               pushButtonDetecter->setIconSize(QSize(25, 25));


               verticalLayoutDetecterSmartphone->addWidget(pushButtonDetecter);

               horizontalLayout_3->addLayout(verticalLayoutDetecterSmartphone);
...
//               horizontalLayout_3->addItem(horizontalSpacer_5);
    ...
    void retranslateUi(QWidget *IHMSynchronisation)
    {
        ...
        //Modifications 2020
        labelDetecterSmartphone->setText(QApplication::translate("IHMSynchronisation", "Rechercher un nouveau smartphone connect\303\251 :", 0));
        pushButtonDetecter->setText(QApplication::translate("IHMSynchronisation", "  D\303\251tecter", 0));
        //Fin
        pushButtonSynchroniser->setText(QApplication::translate("IHMSynchronisation", "  Synchroniser", 0));
        pushButtonDetails->setText(QApplication::translate("IHMSynchronisation", "D\303\251tails >>", 0));
    } // retranslateUi
