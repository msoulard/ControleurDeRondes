...
{
    qDebug() << "IHM_RAPPORT AfficherListeRapports";
...
{
    qDebug() << "IHM_RAPPORT AfficherListePointeaux";
 ...
 * @brief IHMRapport::ExporterPDF
 *  Cette fonction permet la création et l'attribution des données dans un fichier PDF
 */
void IHMRapport::ExporterPDF()
{
    ...
    if(rapportActu >= 0)
    {
        ...
        if (!fileName.isEmpty()) {
            ...
            painter.setFont(QFont("Verdana", 20, QFont::Bold));
            painter.drawText(entete,Qt::AlignHCenter|Qt::AlignRight,"BarbeDevaux");
        ...
        QString commande("C:/Program Files (x86)/Adobe/Acrobat Reader DC/Reader/AcroRd32.exe");
...
QString &IHMRapport::ObtenirlecteurPDF()
{
    return lecteurPDF;
}

void IHMRapport::ModifierLecteurPDF(QString _lecteur)
{
    lecteurPDF = _lecteur;
}
...
/**
 * @author Antoine CHEVREL
 * @brief IHMRapport::on_pushButtonAppliquerFiltre_clicked
 * Cette fonction permet au filtre de ne pas s'actualiser a chaque modification de valeurs
 */
void IHMRapport::on_pushButtonAppliquerFiltre_clicked()
{
    ActualiserListeNomAgent();
    ActualiserListeNomRonde();
    ActualiserListeRapports();
...
/**
 * @author Antoine CHEVREL
 * @brief IHMRapport::ActualiserListeNomRonde
 * Cette fonction permet de récupérer le nom des rondes effectuer et de les positionners dans les filtres correspondant
 */
void IHMRapport::ActualiserListeNomRonde()
{
    qDebug() << "IHMRapport : ActualiserListeNomRonde";
 ...
 * @author Antoine CHEVREL
 * @brief IHMRapport::ActualiserListeNomRonde
 * Cette fonction permet de récupérer le nom des agents qui ont effectuer une ronde et de les positionners dans les filtres correspondant
 */
void IHMRapport::ActualiserListeNomAgent()
{
    qDebug() << "IHMRapport : ActualiserListeNomAgent";
...
/**
 * @author Antoine CHEVREL
 * @brief IHMRapport::ActualiserListeRapports
 * Cette fonction permet de remplir le tableau affichant les rondes.
 */
void IHMRapport::ActualiserListeRapports()
{
    qDebug() << "IHM_RAPPORT ActualiserListeRapports";
    pointeauActu = -1;
    rapportActu = -1;
...
{
    qDebug() << "IHMRapport CalculerFiltres";
    ...
    qDebug() << "résultat dans IHMRapport CalculerFiltre : " << resultat;
    return resultat;
}
