...
void SupervisionRondier::onResponsableConnecte()
{
    ...
    tabLocalisation = new IHMLocalisation(*mySqlBdd);
    QIcon iconeLocalisation(":/images/emplacementIcon.png");
    ...
    widgetTab->addTab(tabLocalisation, iconeLocalisation, "Gestion Emplacements");
